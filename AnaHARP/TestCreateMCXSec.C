...
//Compiling: g++ -o TestCreateMCXSec TestCreateMCXSec.C `root-config --cflags --glibs`
//Running: ./TestCreateMCXSec [file with the list of input files] [output root file]

void TestCreateMCXSec(const char* infile, const char* out_histfile){
...
int main(int argc, const char* argv[]){
  TestCreateMCXSec(argv[1],argv[2]);
  return 0;
}
# endif
